...
json_object *convertToJSON(FILE *file, Header header)
{
    ...
    for (i = 0; i < header.ParkingSpaceDataCount; i++)
    {
        ...
        // 완성된 jParkingSpace 객체를 jParkingSpaces 배열에 추가합니다.
